...
?>
    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-12">
                ...
                if (version_compare($remoteVersion, $user_spice_ver) == 1) { ?>
                    <strong><font color="red">This is not the latest version.</font></strong>  The latest version is
                    <strong><?= $remoteVersion ?></strong>. You are free to install this version, but you can also download the latest version at
                ...
                <p>If you have not already created a new <font color="red"><strong>database</strong></font>, please do
                    so
                    at this time. Make sure that you have the Host Name, Username, Password, and Database name handy, as
                    you
                ...
                if (version_compare(phpversion(), $php_ver, '<')) {
                    ...
                    ?>
                    <div class="alert alert-danger" role="alert">We're sorry, but your PHP version is out of date.
                        Please update to PHP <?= $php_ver ?> or later to
                        continue. <a href='http://php.net/' target='_blank'>PHP Website</a></div>
                    <?php
                } else {
                    ?>
                    <p>Your PHP version meets the minimum system requirements of <?= $php_ver ?> or later, but you need
                        to
                        make sure your system meets all the rest of the requirements. If you see any red in the table
                        below,
                        ...
                        <tr>
                            ...
                            <td class="font-weight-bold">
                                ...
                                if (@file_exists($config_file) && @is_writable($config_file)) {
                                    ...
                                    how to chmod your init file, <a href="//userspice.com/installation-issues/"
                                                                    target="_blank">please read this guide
                                        at UserSpice.com.</a>
                                <?php } ?>
                            </td>
                        </tr>
                ...
                <div class="col-6">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="defaultCheck2">
                            By clicking continue, you agree with the terms of the <a href="license.php"
                                                                                     target="_blank"><?= $app_name ?>
                                License.</a>
                        </label>
                    </div>
                </div>
        ...
        <?php if ($phpWarn === 1) { ?>
            <div class="alert alert-primary" role="alert">Your PHP is out of date and you are using an unsupported
                version.
