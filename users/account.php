        ...
        <div class="well">
            <div class="row">
                <div class="col-sm-12 col-md-3">
                    ...
                    <p><a href="../users/user_settings.php"
                          class="btn btn-primary btn-block"><?= lang('ACCT_EDIT'); ?></a></p>
                ...
                <div class="col-sm-12 col-md-9">
                    ...
                    <p>
                        <span id="fname"><?= ucfirst($user->data()->fname) . ' ' . ucfirst($user->data()->lname); ?> </span><span
                                id="slash">/</span> <span id="lname"><?= echouser($user->data()->id); ?></span></p>
