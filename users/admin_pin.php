    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-7">
                ...
                <p>PIN Codes are used for verification when accessing administrative pages. Your PIN should be 4-10
                    digits long.</p>
            </div>
            ...
            <form class="verify-admin" action="" method="POST" id="payment-form">
                <div class="col-md-3">
                    <input class="form-control" type="password" name="pin" id="pin"
                           placeholder="Please enter your PIN code" autocomplete="new-password" required autofocus>
                </div>
                <div class="col-md-4">
                    <div class="input-group"><input class="form-control" type="password" name="pin_confirm"
                                                    id="pin_confirm" placeholder="Please confirm your PIN code"
