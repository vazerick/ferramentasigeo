            ...
            <p align="center">
                ...
                foreach ($languages as $k => $v) {
                    ...
                    if (file_exists($abs_us_root . $us_url_root . 'users/lang/flags/' . $languages[$k] . '.png')) { ?>
                        <input type="image" title="<?php echo $languages[$k]; ?>" alt="<?php echo $languages[$k]; ?>"
                               name="<?php echo $languages[$k]; ?>"
                               src="<?php echo $us_url_root . 'users/lang/flags/' . $languages[$k] . '.png'; ?>"
                               border="0" alt="Submit" style="width: 40px;"/>
                    <?php }
                } ?>
            </p>
