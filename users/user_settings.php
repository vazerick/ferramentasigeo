                    ...
                    <form name='updateAccount' action='' method='post'>
                        ...
                        <div class="form-group" id="username-group">
                            ...
                            <input class='form-control' type='text' id="username" name='username'
                                   value='<?= $userdetails->username; ?>' autocomplete="off"
                                   <?php if (($settings->change_un == 0) || (($settings->change_un == 2) && ($userdetails->un_changed == 1))) { ?>readonly<?php } ?>>
                            <?php if (($settings->change_un == 0) || (($settings->change_un == 2) && ($userdetails->un_changed == 1))) { ?>
                                <sup>
                                    <span class="input-group-addon" data-toggle="tooltip"
                                          title="<?php if ($settings->change_un == 0) { ?><?= lang('SET_NOCHANGE'); ?><?php }
                        ...
                        <div class="form-group" id="fname-group">
                            ...
                            <input class='form-control' type='text' id='fname' name='fname'
                                   value='<?= $userdetails->fname; ?>' autocomplete="off"/>
                        </div>

                        <div class="form-group" id="lname-group">
                            <label id="lname-label"><?= lang('GEN_LNAME'); ?></label>
                            <input class='form-control' type='text' id="lname-label" name='lname'
                                   value='<?= $userdetails->lname; ?>' autocomplete="off"/>
                        </div>

                        <div class="form-group" id="email-group">
                            <label id="email-label"><?= lang('GEN_EMAIL'); ?></label>
                            <input class='form-control' type='text' id="email" name='email'
                                   value='<?= $userdetails->email; ?>' autocomplete="off"/>
                        ...
                        <div class="form-group" id="password-group">
                            <label id="password-label"><?= lang('PW_NEW'); ?>
                            ...
                            <div class="input-group" data-container="body">
                                <span class="btn btn-secondary input-group-addon password_view_control"
                                      id="addon1"><span class="fa fa-eye"></span></span>
                                <input class="form-control" type="password" name="password" id="password"
                                       aria-describedby="passwordhelp" autocomplete="off">
                                <span class="btn btn-secondary input-group-addon" id="addon2" data-container="body"
                                      data-toggle="tooltip" data-placement="top"
                                      title="<?= $settings->min_pw; ?> <?= lang('GEN_CHAR'); ?> <?= lang('GEN_MIN'); ?>, <?= $settings->max_pw; ?> <?= lang('GEN_MAX'); ?>.">?</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="confirm-group">
                            ...
                            <div class="input-group" data-container="body">
                                <span class="btn btn-secondary input-group-addon password_view_control"
                                      id="addon3"><span class="fa fa-eye"></span></span>
                                <input type="password" autocomplete="off" id="confirm" name="confirm"
                                       class="form-control" autocomplete="off">
                                <span class="btn btn-secondary input-group-addon" id="addon4" data-container="body"
                                      data-toggle="tooltip" data-placement="top"
                                      title="<?= lang('SET_PW_MATCH'); ?>">?</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="old-group">
                            ...
                            <div class="input-group" data-container="body">
                                <span class="btn btn-secondary input-group-addon password_view_control"
                                      id="addon6"><span class="fa fa-eye"></span></span>
                                <input class='form-control' type='password' id="old" name='old'
                                       <?php if (is_null($userdetails->password)) { ?>disabled<?php } ?>
                                       autocomplete="off"/>
                                <span class="btn btn-secondary input-group-addon" id="addon5" data-container="body"
                                      data-toggle="tooltip" data-placement="top"
                                      title="<?= lang('SET_PW_REQI'); ?>">?</span>
                            </div>
                        </div>
