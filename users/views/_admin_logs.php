        ...
        <table id="logstable" class='table table-hover table-striped table-list-search display'>
            ...
            <?php foreach ($logs as $l) { ?>
                <tr>
                    ...
                    <td><?php echouser(Input::sanitize($l->user_id)); ?> (<?php echo Input::sanitize($l->user_id); ?>)
                    </td>
                    ...
                    <td>
                        <div class="input-group">
                            ...
                            if (strlen($l->lognote) > 80) { ?>
                                <textarea style="padding-top:0px; padding-left:5px;" rows="1" class="form-control"
                                          readonly><?php echo Input::sanitize($l->lognote); ?></textarea>
                                <?php
                            } else {
                    ...
                    <td>
                        <?php if ($l->metadata !== null) { ?>
                            <i class="fa fa-fw fa-sticky-note pull-right"
                               onclick="generateMetadataModal(<?php echo $l->id; ?>)" title="View<br>Metadata"
                               data-html="true" data-toggle="tooltip"></i>
                        <?php } ?>
                    </td>
                </tr>
            <?php } ?>
