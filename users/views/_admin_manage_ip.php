                    ...
                    <form action="" method="post">
                        <div class="form-row">
                            <div class="input-group col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" aria-describedby="ip-label" name="ip"
                            ...
                            <input type="submit" name="newIP" value="Add IP"
                                   class="btn btn-danger form-control col-md-1  mb-3">
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="card-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-whitelisted-tab" data-toggle="tab"
                               href="#nav-whitelisted" role="tab" aria-controls="nav-whitelisted" aria-selected="true">Whitelist</a>
                            <a class="nav-item nav-link" id="nav-blacklisted-tab" data-toggle="tab"
                               href="#nav-blacklisted" role="tab" aria-controls="nav-blacklisted" aria-selected="false">Blacklist</a>
                        </div>
                    </nav>
                    <form class="" action="" method="post">
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-whitelisted" role="tabpanel"
                                 aria-labelledby="nav-whitelisted-tab">
                                <div class="row">
                                    <div class="col-md-12">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="switch switch-text switch-success">
                                                            <input type="checkbox" class="switch-input toggle"
                                                                   data-desc="Remove from Blacklist"
                                                                   name="deletewhite[<?= $b->id ?>]"
                                                                   value="<?= $b->id ?>">
                            ...
                            <div class="tab-pane fade" id="nav-blacklisted" role="tabpanel"
