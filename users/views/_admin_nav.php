                    ...
                    <table class="table table-bordered table-hover table-condensed" id="navTable">
                        ...
                        foreach ($menu_items as $item) {
                            ...
                            <tr>
                                ...
                                <td><p class="oce text-dark" data-id="<?= $item->id ?>" data-field="link"
                                       data-input="input"><?= $item->link ?></p></td>

                                <td><p class="oce text-dark" data-id="<?= $item->id ?>" data-field="dropdown"
                                       data-input="select"><?= ($item->dropdown) ? 'Yes' : 'No'; ?></p></td>
                                <td>
                                    <?php
                                    $sep = '';
                                ...
                                <td><p class="oce text-dark" data-id="<?= $item->id ?>" data-field="logged_in"
                                       data-input="select"><?= ($item->logged_in) ? 'Yes' : 'No'; ?></p></td>
                                <td><p class="oce text-dark" data-id="<?= $item->id ?>" data-field="display_order"
                                       data-input="input"><?= $item->display_order ?></p</td>


                                <td><?= $item->icon_class ?></td>
                                <td>
                                    <a class="text-dark" href="admin.php?view=nav_item&id=<?= $item->id ?>&action=edit"><span
                                                class="fa fa-cog fa-lg"></span></a> /
                                    <a class="text-dark"
                                       href="admin.php?view=nav&id=<?= $item->id ?>&action=delete"><span
                                                class="fa fa-remove fa-lg"></span></a></td>
                            </tr>
                            <?php
                            $i++;
                        }
