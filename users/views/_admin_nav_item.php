...
<div class="content mt-3">
    ...
    <form name='edit_menu_item' action='' method='post'>
        ...
        <div class="form-group">
            <label>Icon Class (<a href="https://fontawesome.bootstrapcheatsheets.com/"
                                  target="_blank">options</a>)</label>
        ...
        <p class="text-center"><input class='btn btn-primary' name='update' type='submit' value='Update'
                                      class='submit'/>
