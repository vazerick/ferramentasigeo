...
<div class="content mt-3">
    ...
    <h2>Manage Page Access
        <?php if ($c) { ?>
            <button type="button" onclick="window.location.href = 'admin.php?view=pages';" name="button"
                    class="btn btn-primary">Show All Pages
            </button>
        <?php } else { ?>
            <button type="button" onclick="window.location.href = 'admin.php?view=pages&hide=core';" name="button"
                    class="btn btn-primary">Hide Default Pages
            </button>
        <?php } ?>
    </h2>
        ...
        <div class="card-body">
            <table id="pagestable" class='table table-hover table-list-search'>
                ...
                foreach ($dbpages as $page) {
                    ...
                    <tr>
                        <td><?= $dbpages[$count]->id; ?></td>
                        <td><a class="nounderline text-dark"
                               href='admin.php?view=page&id=<?= $dbpages[$count]->id; ?>'><?= $dbpages[$count]->page; ?></a>
                        </td>
                        <td><a class="nounderline text-dark"
                               href='admin.php?view=page&id=<?= $dbpages[$count]->id; ?>'><?= $dbpages[$count]->title; ?></a>
                        </td>
                        <td>
