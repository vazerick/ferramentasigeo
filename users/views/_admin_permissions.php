...
<div class="content mt-3">
    ...
    <div class="class col-md-6 offset-md-3 col-sm-12">
        ...
        <table class='table table-hover table-list-search'>
            <tr>
                <?php /*<th>Delete</th> //LEGACY BA 9162017 */ ?>
                <th>Permission Name (Click a Permission Name to Manage It)</th>
            </tr>
            ...
            foreach ($permissionData as $v1) {
                ...
                <tr>
                    ...
                    <td>
                        <a href='admin.php?view=permission&id=<?= $permissionData[$count]->id ?>'><?php echo ucfirst($permissionData[$count]->name); ?></a>
                    </td>
                </tr>
                <?php
                $count++;
