    ...
    <div class="row">
        <div class="col-12 mb-2">
            ...
            <div class="d-flex align-content-end float-right">
                <div class="mr-2">
                    <a class="btn btn-outline-dark pull-right" href="admin.php?view=spice&type=plugin">Download Official
                        Plugins</a>
                </div>
                <div>
                    <a class="btn btn-outline-dark pull-right" href="https://userspice.com/plugins" class="button">Download
                        More Plugins</a>
                </div>
            </div>
        </div>
                                    ...
                                    <td>
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="pr-3">
                                                <?php if (pluginActive($t, true)) { ?>
                                                    <a href="<?= $us_url_root . 'users/admin.php?view=plugins_config&plugin=' . $t ?>">
                                                        <img src="<?= $img_src ?>" class="hov" alt="thumbnail"
                                                             width="100">
                                                    </a>
                                                <?php } else { ?>
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <small class="ml-2"><strong>Author: </strong><a class="text-dark"
                                                                                                href="<?= $xml->website ?>"><?= $xml->author ?></a></small>
                                                <small class="ml-2"><strong>Released: </strong><?= $xml->release ?>
                                                </small>
                                                <small class="ml-2"><strong>Version: </strong><?= $xml->version ?>
                                                </small>
                                                <small class="ml-2"><strong>Tested With: </strong><?= $xml->tested ?>
                                                </small>
                                            </div>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form class="" action="" method="post">
                                            ...
                                            <?php if (file_exists($abs_us_root . $us_url_root . "usersc/plugins/" . $t . "/.noupdate")) { ?>
                                                <button type="submit" name="action" value="unlockme" class="btn"
                                                        title="Unlock this plugin to allow Spice Shaker to update it.">
                                                    <i class="fa fa-lock" aria-hidden="true"></i>
                                                </button>
                                            <?php } else { ?>
                                                <button type="submit" name="action" value="lockme" class="btn"
                                                        title="Lock this plugin to prevent plugin from being updated">
                                            ...
                                            <form class="" action="" method="post">
                                                ...
                                                <?php if ($usplugins[$t] == 1) {  //plugin installed and active ?>
                                                    <button type="submit" name="deactivate" value="Deactivate"
                                                            class="btn btn-outline-dark" title="Deactivate">
                                                        <i class="fa fa-ban" aria-hidden="true"></i>
                                                    </button>
                                                    <a class="btn btn-outline-primary" title="Configure"
