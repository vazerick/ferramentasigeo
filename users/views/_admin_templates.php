...
<div class="content mt-3">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-8">
                <a href="admin.php?view=spice&type=template">Download Official Templates</a> or <a
                        href="https://userspice.com/templates">Download More Templates</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <?php foreach ($templates as $t) { ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <img src="<?= $us_url_root . 'usersc/templates/' . $t . '/thumbnail.jpg' ?>" alt="thumbnail"
                                 width="300">
                            <?php
                            if (file_exists($abs_us_root . $us_url_root . 'usersc/templates/' . $t . '/preview.php')) {
                                ?>
                                <p align="center"><a href="../usersc/templates/<?= $t ?>/preview.php" type="button"
                                                     class="btn btn-primary">Preview</a></p>
                            <?php } else { ?>
                                <p align="center"><a href="#" type="button" class="btn btn-default">No Preview
                                        Available</a></p>
                            <?php } ?>
                            <form class="" id="temlate" action="" method="post">
                                ...
                                <?php if ($t != $settings->template) { ?>
                                    <p align="center"><input type="submit" name="activate" value="Activate"
                                                             class="btn btn-primary"></p>

                                <?php } else { ?>
                                    <p align="center"><input type="button" name="go" value="Active"
