        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" name="backup" method="POST">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="backup_dest" id="backup_dest"
                                           placeholder="Backup Destination" value="<?= $settings->backup_dest ?>">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button class='btn btn-success' type='submit' name="backup" value='Backup'
                                        onclick="window.location='<?= $_SERVER['PHP_SELF']; ?>';"><i
                                            class="fa fa-database"></i><?= lang('AB_BACKUP_BTN'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4><?= lang('AB_EXIST_BACKUP'); ?><span
                                class="badge badge-success"><?= sizeof($allBackupFiles) ?></span></h4>
                </div>
                <div class="card-body">
                    ...
                    <form name="delete" action="" method="post">
                        ...
                        <table id="backups" class='table table-striped' cellspacing="0" width="100%">
                            ...
                            <tr class="headings">
                                <th class="column-title" style="width: 20px;">
                                    <?php if (sizeof($allBackupFiles) > 1) { ?><input type="checkbox"
                                                                                      class="checkAllBackups"/><?php } ?>
                                </th><!-- select all boxes -->
                            ...
                            foreach ($allBackupFiles as $backupFile) {
                                ...
                                <tr>
                                    <td class="a-center ">
                                        <input type='checkbox' class="flat" name='delete[<?= $filename ?>]'
                                               value='<?= $filename ?>' style="width: 10px!important;"/>
                                    </td>
                                    ...
                                    <td class="text-center last" style="width: 10%;">
                                        <a class="label label-success bg-green"
                                           href="<?= $us_url_root . $backup_dest . $filename ?>"><i
                        ...
                        <button class="btn btn-danger"
                                onclick="window.location='<?= $us_url_root ?>users/admin.php?view=backup';"
                                type="submit" name="deleteFile" value="delete"><i
                                    class="fa fa-trash"></i><?= lang('AB_DELETE_B'); ?></button>
