...
<div class="content mt-3">
    ...
    <?php if ($remoteVersion != $user_spice_ver && $settings->spice_api != '') { ?>
        ...
        <div class="text-center">
            <form class="" action="" method="post">
                ...
                It's always a good idea to <strong><a href="<?= $us_url_root; ?>users/admin.php?view=backup">backup
                        UserSpice</a></strong> before updating.
            </form>
        </div>
        <br>
    ...
    <div class="row">
        <div class="col-12 text-center">
            Any messages below this are from ACTIVE plugins that are checking to make sure they have the latest database
            updates.
