    ...
    <div class="row">
        <div class="col-12 mb-2">
            ...
            <div class="w-100 text-right">
                <button class="btn btn-outline-dark" data-toggle="modal" data-target="#adduser"><i
                    ...
                    <div class="allutable">
                        <table id="userstable" class='table table-hover table-list-search'>
                            ...
                            <tr>
                                ...
                                <th>Username</th>
                                <th>Name</th>
                                <th>Email</th><?php includeHook($hooks, 'body'); ?>
                                <th>Last Sign In</th><?php if ($act == 1) { ?>
                                    <th>Verified</th><?php } ?>
                                <th>Status</th>
                            </tr>
                            </thead>
                            ...
                            foreach ($userData as $v1) {
                                ?>
                                <tr>
                                    <td><a class="nounderline text-dark"
                                           href='admin.php?view=user&id=<?php echo $v1->id; ?>'><?php echo $v1->id; ?></a>
                                    </td>
                                    <td><a class="nounderline text-danger"
                                           href='admin.php?view=user&id=<?php echo $v1->id; ?>'><?php if ($v1->force_pr == 1) { ?>
                                                <i class="fa fa-lock"></i><?php } ?></a></td>
                                    <td><a class="nounderline text-dark"
                                           href='admin.php?view=user&id=<?php echo $v1->id; ?>'><?php echo $v1->username; ?></a>
                                    </td>
                                    <td><a class="nounderline text-dark"
                                           href='admin.php?view=user&id=<?php echo $v1->id; ?>'><?php echo $v1->fname; ?><?php echo $v1->lname; ?></a>
                                    </td>
                                    <td><a class="nounderline text-dark"
                                           href='admin.php?view=user&id=<?php echo $v1->id; ?>'><?php echo $v1->email; ?></a>
                                    </td>
                                    ...
                                    <td>
                                        <i class="fa fa-fw fa-<?php if ($v1->permissions == 1) { ?>un<?php } ?>lock"></i>
                                    </td>
                                </tr>
                                <?php
                            } ?>
                        ...
                        <?php if ($showAllUsers != 1) { ?><a href="?view=users&showAllUsers=1"
                                                             class="btn btn-primary nounderline pull-right">Show All
                            Users</a><?php } ?>
                        <?php if ($showAllUsers == 1) { ?><a href="?view=users"
                                                             class="btn btn-primary nounderline pull-right">Show Active
                            Users Only</a><?php } ?>
                    </div>
                </div>
            </div>
                ...
                <form class="form-signup mb-0" action="" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group" id="username-group">
                            <label>Username (<?php echo $settings->min_un; ?>-<?php echo $settings->max_un; ?>
                                chars)<span id="usernameCheck" class="small ml-2"></span></label>
                        ...
                        <div class="form-group">
                            <label>Password (<?php echo $settings->min_pw; ?>-<?php echo $settings->max_pw; ?>
                                chars)</label>
                            <div class="input-group" data-container="body">
                                <div class="input-group-append">
                                    <span class="input-group-text password_view_control" id="addon1"><span
                                                class="fa fa-eye"></span></span>
                                </div>
                                <input class="form-control" type="password" name="password" id="password"
                                       <?php if ($settings->force_pr == 1) { ?>value="<?php echo $random_password; ?>"
                                       readonly<?php } ?> placeholder="Password" required autocomplete="off"
                                       aria-describedby="passwordhelp">
                                <?php if ($settings->force_pr == 1) { ?>
                                    <div class="input-group-append">
                                        <span class="input-group-text" id="addon2"><a class="nounderline pwpopover"
                                                                                      data-container="body"
                                                                                      data-toggle="popover"
                                                                                      data-placement="top"
                                                                                      title="Why can't I edit this?"
                                                                                      data-content="The Administrator has manual creation password resets enabled. If you choose to send an email to this user, it will supply them with the password reset link and let them know they have an account. If you choose to not, you should manually supply them with this password (discouraged)."><i
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" data-container="body">
                                ...
                                <input type="password" id="confirm" name="confirm"
                                       <?php if ($settings->force_pr == 1) { ?>value="<?php echo $random_password; ?>"
                                       readonly<?php } ?> class="form-control" autocomplete="off"
                    ...
                    <div class="modal-footer">
                        ...
                        <input class='btn btn-primary submit' type='submit' id="addUser" name="addUser"
                               value='Add User'/>
            ...
            function check_username_ajax(username) {
                ...
                $.post('parsers/existingUsernameCheck.php', {'username': username}, function (response) {
                    if (response == 'error') $('#usernameCheck').html('There was an error while checking the username.');
                        ...
                        $('#usernameCheck').html('<i class="fa fa-times" style="color: red; font-size: 12px"></i> This username is taken.');
                        $('#addUser').prop('disabled', true);
                    } else if (response == 'valid') {
                        $('#usernameCheck').html('<i class="fa fa-thumbs-o-up" style="color: green; font-size: 12px"></i> This username is not taken.');
