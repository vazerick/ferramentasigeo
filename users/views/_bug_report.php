...
<div class="content mt-3">
    <h2>Bug Report</h2>
    <p>A System report will be submitted with the following information to help in the diagnosis of the problem. If you
        don't want to submit this information, please submit a report directly at https://bugs.userspice.com. Please
        note that the API may collect other information about the API call itself in order to prevent spam.
    </p>
    <?php if ($settings->spice_api == '') { ?>
        ...
        <form class="" action="" method="post">
            <input type="password" autocomplete="new-password" class="form-control" data-desc="UserSpice API Key"
            ...
            <?php foreach ($result->fetch as $p) { ?>
                <tr>
                    ...
                    <td><a class="btn btn-primary"
                           href="https://bugs.userspice.com/usersc/issue_detail.php?id=<?= $p->kIssueID ?>">View
                            Ticket</a></td>
                </tr>
            <?php } ?>
            </tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.paginate').DataTable({
                "pageLength": 25,
                "stateSave": true,
                "aLengthMenu": [[25, 50, 100, -1], [25, 50, 100, 250, 500]],
                "aaSorting": []
            });
        });
