...
<div class="content mt-3">
    ...
    <p class="text-dark">Please Note: Allowing users other than trusted admins should not be taken lightly. You are
        giving these users the opportunity to do some very
        powerful things to your site.</p>
    <p class="text-dark">This is a TWO step process. You must go into Page Management and allow the other access
        level(s) that you want to give access to, permission
        to access the admin.php page. Then you can come in here and grant that access level permission to a particular
        section of the dashboard.
        Please note, some actions are limited by default to users of the master account or admins (permission level 2)
        and cannot be overriden on this
        page.</p>
                            ...
                            <?php foreach ($perms as $key => $value) {
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="<?= $f->feature ?>[]"
                                               value="<?= $key ?>" <?= $isChecked ?> id="<?= $elId ?>">
