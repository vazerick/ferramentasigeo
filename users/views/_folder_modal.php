            ...
            <div class="modal-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="" action="" method="post">
                                        ...
                                        <div class="btn-group pull-right"><input class="btn btn-danger" type="submit"
                                                                                 name="removeFolder" value="Remove">
                                        </div>
                                    </form>
                                </td>
                            </tr>
                ...
                <div class="form-group">
                    <form class="inline-form" action="" method="POST" id="newFormForm">
                        ...
                        <div class="btn-group pull-right"><input class='btn btn-primary' type='submit' name="addFolder"
                                                                 value='Monitor Folder' class='submit'/></div>
                    </form>
                </div>
            </div>
