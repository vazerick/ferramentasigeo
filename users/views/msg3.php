                          ...
                          <span class="chat-img pull-left" style="padding-right:5px">
                            <a class="nounderline" href="message.php?id=<?= $m2->id ?>">
                              <img src="<?= $grav ?>" width="75" class="img-thumbnail">
                                ...
                                <td class="pull-left">
                                    <h4>
                                        <input type="checkbox" class="checkarchive" name="checkbox[<?= $m2->id ?>]"
                                               value="<?= $m2->id ?>"/>
                                        <a class="nounderline" href="message.php?id=<?= $m2->id ?>">
                                            <?= $m2->msg_subject ?> -
                                            with <?php if ($m2->msg_from == $user->data()->id) {
                                                echouser($m2->msg_to);
                                            } else {
                            ...
                            <?php }
                                ...
                                <td colspan="2">
                                    <center><h3><?= lang("MSG_NO_ARC"); ?></h3></center>
                                </td></tr>
                            <?php } ?>
                            </tbody>
                        </table>
