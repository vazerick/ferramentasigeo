        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_mass_message" action="messages.php" method="post">
                    ...
                    <label><input type="checkbox" name="sendEmail" id="sendEmail" checked/> <?= lang("MSG_QUEST"); ?>
                    </label>
            ...
            <div class="modal-footer">
                <input type="hidden" name="csrf" value="<?= $csrf ?>"/>
                <input class='btn btn-primary' type='submit' name="send_mass_message" value='<?= lang("MSG_SEND"); ?>'
                       class='submit'/></div>
            </form>
            <div class="btn-group">
