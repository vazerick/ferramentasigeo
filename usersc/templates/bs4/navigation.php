...
if ($navstyle == 'Default') {
    ...
    if ($settings->navigation_type == 0) {
        ...
        <div class="col-md-3 float-left col-1 pl-0 pr-0 width collapse show" id="sidebar" aria-expanded="true">
            <div class="list-group border-0 card text-center text-md-left">
                <?php if ($user->isLoggedIn()) { //anyone is logged in?>
                    <a href="<?= $us_url_root ?>" class="list-group-item d-inline-block collapsed"
                       data-parent="#sidebar"><i class="fa fa-home"></i> <span
                    ...
                    <?php if ($settings->notifications == 1) { ?>
                        ...
                        <a class="list-group-item d-inline-block collapsed" href="#"
                           onclick="displayNotifications('new')" id="notificationsTrigger" data-toggle="modal"
                           data-target="#notificationsModal" style="text-decoration: none;"><span
                                    class="fa fa-bell-o"></span> <span id="notifCount"
                                                                       class="badge badge-pill badge-primary"
                                                                       style="margin-top: -5px;"><?= (int)$notifications->getUnreadCount(); ?></span>
                            Notifications</a>
                    <?php } ?>
                    <a class="list-group-item d-inline-block collapsed" href="<?= $us_url_root ?>users/account.php"><i
                                class="fa fa-user"></i> <span
                                class="d-none d-md-inline"><?php echo echousername($user->data()->id); ?></span></a>
                    <a href="#menu1" class="list-group-item d-inline-block collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="fa fa-cog"></i> <span class="d-none d-md-inline"> Settings</span>
                    </a>
                    <div class="collapse" id="menu1" data-parent="#sidebar">
                        <a href="<?= $us_url_root ?>users/admin.php" class="list-group-item collapsed">Admin
                            Dashboard</a>
                        <a href="<?= $us_url_root ?>users/admin.php?view=users" class="list-group-item collapsed">User
                            Management</a>
                        <a href="<?= $us_url_root ?>users/admin.php?view=permissions" class="list-group-item collapsed">Page
                            Permissions</a>
                        <a href="<?= $us_url_root ?>users/admin.php?view=pages" class="list-group-item collapsed">Page
                            Management</a>
                        <a href="<?= $us_url_root ?>users/admin.php?view=logs" class="list-group-item collapsed">System
                            Logs</a>
                ...
                <?php } else { ?>
                    <a href="#" class="list-group-item d-inline-block collapsed" data-parent="#sidebar"><i
                                class="fa fa-home"></i> <span class="d-none d-md-inline">Home</span></a>
                    <a href="<?= $us_url_root ?>users/login.php" class="list-group-item d-inline-block collapsed"><i
                                class="fa fa-sign-in"></i> Login</a>
                    <a href="<?= $us_url_root ?>users/join.php" class="list-group-item d-inline-block collapsed"><i
                                class="fa fa-plus-square"></i> Register</a>
                    <a href="#menu2" class="list-group-item d-inline-block collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="fa fa-cog"></i> <span class="d-none d-md-inline">Help</span> </a>
                    <div class="collapse" id="menu2" data-parent="#sidebar">
                        <a href="<?= $us_url_root ?>users/forgot_password.php"><i class="fa fa-wrench"></i> Forgot
                            Password</a>
                        <?php if ($email_act) { //Only display following menu item if activation is enabled ?>
                            <a href="<?= $us_url_root ?>users/verify_resend.php"><i
        ...
        <button class="hamburger hamburger--arrowalt is-active" data-target="#sidebar" data-toggle="collapse"
                type="button" style="float:left;display:flex;">
        ...
        <div class="" style="background-color: #023c73;">
            <div class="text-center">
                <a style="left:-35px;position: relative;" href="<?= $us_url_root ?>"><img style=""
                                                                                          src="<?= $us_url_root ?>users/images/logo.png"></a>
            </div>
        </div>
    <?php }
    if ($settings->navigation_type == 1) {
    ...
    if ($settings->navigation_type == 0) {
        ...
        <div class="col-md-3 float-right col-1 pl-0 pr-0 width collapse show" id="sidebarLeft" aria-expanded="true">
            <div class="list-group border-0 card text-center text-md-right">
                <?php if ($user->isLoggedIn()) { //anyone is logged in?>
                    <a href="<?= $us_url_root ?>" class="list-group-item d-inline-block collapsed"
                       data-parent="#sidebarLeft"><i class="fa fa-home"></i> <span
                                class="d-none d-md-inline">Home</span></a>
                    <?php if ($settings->notifications == 1) { ?>
                        <?php /*<li><a href="portal/'.PAGE_PATH.'#" id="notificationsTrigger" data-toggle="modal" data-target="#notificationsModal"><i class="fa fa-bell"></i> <span id="notifCount" class="badge" style="margin-top: -5px"><?= (($notifications->getUnreadCount() > 0) ? $notifications->getUnreadCount() : ''); ?></span></a></li>*/ ?>
                    ...
                    <a class="list-group-item d-inline-block collapsed" href="<?= $us_url_root ?>users/account.php"><i
                                class="fa fa-user"></i> <span
                                class="d-none d-md-inline"><?php echo ucfirst(echousername($user->data()->id)); ?></span></a>
                    <a href="#menu1" class="list-group-item d-inline-block collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="fa fa-cog"></i> <span class="d-none d-md-inline"> Settings</span>
                    </a>
                ...
                <?php } else { ?>
                    <a href="#" class="list-group-item d-inline-block collapsed" data-parent="#sidebarLeft"><i
                                class="fa fa-home"></i> <span class="d-none d-md-inline">Home</span></a>
                    <a href="<?= $us_url_root ?>users/login.php" class="list-group-item d-inline-block collapsed"><i
                                class="fa fa-sign-in"></i> Login</a>
                    <a href="<?= $us_url_root ?>users/join.php" class="list-group-item d-inline-block collapsed"><i
        ...
        <button class="hamburger hamburger--arrowalt-r is-active" data-target="#sidebarLeft" data-toggle="collapse"
                type="button" style="float:right;display: flex;">
          <span class="hamburger-box">
            <span class="hamburger-inner"></span>
          </span>
        </button>
        <div class="" style="background-color: #023c73;">
            <div class="text-center">
                <a style="right:-35px;position: relative;" href="<?= $us_url_root ?>"><img style=""
                                                                                           src="<?= $us_url_root ?>users/images/logo.png"></a>
            </div>
        </div>
    <?php }
