...
<main class="container">
    <div class="text-center">
        <h2><a href="../../../users/admin.php?view=templates"><span class="fa fa-arrow-left"></span> Back to Themes</a>
        </h2>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div id="tabsJustifiedContent" class="tab-content">
                    ...
                    <div id="profile1" class="tab-pane fade active show">
                        <div class="row pb-2">
                            <div class="col-md-7">
                                <p>Tabs can be used to contain a variety of content &amp; elements. They are a good way
                                    to group <a href="" class="link">relevant content</a>. Display initial content in
                                    context to the user. Enable the user to flow through
                            ...
                            <li class="list-group-item d-block">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-10 text-center text-sm-left">
                                        ...
                                        <br> <a href="" class="link small text-truncate">seth.frazier@example.com</a>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item d-block">
                        ...
                        <div id="card_list" class="card border-0">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item justify-content-between">
                                    <p class="list-group-item-text m-0">Milk</p> <span><i
                                                class="ion-ios-star-outline"></i></span></a>
                                <a href="#" class="list-group-item">
                            ...
                            <div class="card card-default panel"><a href="" data-toggle="collapse"
                                ...
                                <div id="collapseOne" class="card-body collapse show" data-parent="#accordion">
                                    <p>Food truck quinoa nesciunt laborum for labo lucn. Nihil anim keffiyeh helvetica,
                                        craft beer labore wes anderson cred nesciunt sapiente ea proident. Leggings
                                ...
                                <div id="collapseTwo" class="card-body collapse" data-parent="#accordion">
                                    <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry
                                        richardson ad squid. Officia aute, non cupidatat skateboard dolor brunch. Food
    ...
    <span id="jumbotron" class="anchor"></span>
    <section class="d-flex align-items-center justify-content-center vh-100">
        <div class="row w-100">
            <div class="col mb-4">
                <div id="header"
                     class="jumbotron mb-0 d-flex align-items-center flex-column justify-content-center p-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div role="alert" class="alert alert-success">
                            ...
                            within an alert works with this kind of content. Imagine the content here.
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div role="alert" class="mt-1 alert alert-danger alert-dismissible fade show">
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span
                                        aria-hidden="true">�</span></button>
                            <span class="font-weight-bold">Yo there!</span> You should check <a href="#"
                                                                                                class="alert-link">danger</a>
                    ...
                    <div class="col-sm-6">
                        <div role="alert"
                            ...
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span
                                        aria-hidden="true">�</span></button>
                            <span class="font-weight-bold">Womp!</span> Vestibulum tincidunt ullamcorper eros eget
                            luctus. Nulla porttitor libero.
                        </div>
                        <div role="alert"
                             class="mt-1 alert alert-danger bg-danger text-white alert-dismissible fade show">
                            <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span
                                        aria-hidden="true">�</span></button>
                            <span class="font-weight-bold">Danger!</span> Vestibulum tincidunt ullamcorper eros eget
                            luctus. Nulla porttitor libero.
                        </div>
    ...
    <span id="modals" class="anchor"></span>
    <section class="py-4 mt-2">
        <div class="row">
            <div class="col-md-12">
                <h2>Modals</h2>
                        ...
                        <div class="modal-content text-center p-3">
                            <div class="modal-body text-center">
                                ...
                                <p class="lead">
                                    ...
                                    richardson ad squid. Officia aute, non cupidatat skateboard dolor brunch. Food truck
                                ...
                                <button type="button" data-dismiss="modal"
                                        class="btn btn-lg btn-primary mt-2 text-uppercase"><span aria-hidden="true">Close</span>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <span id="tables" class="anchor"></span>
    <section class="py-4 mt-2">
        <div class="row">
            <div class="col-md-12">
                <h2>Tables</h2>
    ...
    <span id="accordions" class="anchor"></span>
    <section class="py-4 mt-2">
        <div class="row">
            <div class="col-md-12">
    ...
    <span id="buttons" class="anchor"></span>
    ...
    <span id="badges" class="anchor"></span>
    <section class="py-4 mt-2">
        <div class="row">
            <div class="col-md-12">
                <h2>Badges</h2>
