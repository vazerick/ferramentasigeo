        ...
        <div class="col-md-12">
            ...
            <ul id="tabsJustified" class="nav nav-tabs">
                <li class="nav-item"><a href="" data-target="#home1" data-toggle="tab"
                                        class="nav-link small text-uppercase">Home</a></li>
                <li class="nav-item"><a href="" data-target="#profile1" data-toggle="tab"
                                        class="nav-link small text-uppercase active">Profile</a></li>
            ...
            <div id="tabsJustifiedContent" class="tab-content">
                <div id="home1" class="tab-pane fade">
                    <div class="list-group"><a href="" class="list-group-item d-inline-block"><span
                                    class="float-right badge badge-pill badge-dark">51</span> Home Link</a> <a href=""
                                                                                                               class="list-group-item d-inline-block"><span
                                    class="float-right badge badge-pill badge-dark">8</span> Link 2</a> <a href=""
                                                                                                           class="list-group-item d-inline-block"><span
                                    class="float-right badge badge-pill badge-dark">23</span> Link 3</a> <a href=""
                                                                                                            class="list-group-item d-inline-block text-muted">Link
                            n..</a></div>
                </div>
                <div id="profile1" class="tab-pane fade active show">
                    <div class="row pb-2">
                        <div class="col-md-7">
                            <p>Tabs can be used to contain a variety of content &amp; elements. They are a good way to
                                group <a href="" class="link">relevant content</a>. Display initial content in context
                                to the user. Enable the user to flow through
                                <a href="" class="link">more</a> information as needed.
                            </p>
                        </div>
                        <div class="col-md-5"><img src="//dummyimage.com/800x300.png/5fa2dd/ffffff"
                ...
                <div id="messages1" class="tab-pane fade">
                    <div class="list-group"><a href="" class="list-group-item d-inline-block"><span
                                    ...
                                    class="float-right badge badge-pill badge-dark">23</span> Message 3</a> <a href=""
                                                                                                               class="list-group-item d-inline-block text-muted">Message
                            n..</a></div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-lg-6 my-2">
                            <div class="card card-body p-3"><span class="text-primary"><span
                                            class="badge badge-primary float-right">+ 13%</span> Sign-ups </span>
                        ...
                        <div class="col-lg-6 my-2">
                            <div class="card card-body p-3"><span class="text-primary"><span
                                            class="badge badge-primary float-right">80%</span> Usage </span>
                                <div class="progress mt-4">
                        ...
                        <div class="col-lg-6 my-2">
                            <div class="card card-body p-3"><span class="text-primary"><span
                                            class="badge badge-primary float-right">78</span> Bursts </span>
                                <div class="progress mt-4">
                        ...
                        <div class="col-lg-6 my-2">
                            <div class="card card-body p-3"><span class="text-success"><span
                                            class="badge badge-success float-right">+ 26%</span> Returning </span>
                                <div class="progress mt-4">
                        ...
                        <div class="col-lg-6 my-2">
                            <div class="card card-body p-3"><span class="text-primary"><span
                                            class="badge badge-primary float-right">201</span> Sales </span>
                                <div class="progress mt-4">
                        ...
                        <div class="col-lg-6 my-2">
                            <div class="card card-body p-3"><span class="text-success"><span
                                            class="badge badge-success float-right">+ 74%</span> Pageviews </span>
                                <div class="progress mt-4">
                ...
                <div id="contacts" aria-expanded="true" role="tabpanel" class="panel-collapse collapse show">
                    <ul id="contact-list" class="list-group">
                        <li class="list-group-item d-block">
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-2"><img src="//placehold.it/80"
                        ...
                        <li class="list-group-item d-block">
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-2"><img src="//placehold.it/80" alt="Seth Frazier"
                                                                           class="img-fluid rounded-circle mx-auto d-block">
                                </div>
                                <div class="col-12 col-sm-6 col-md-10 text-center text-sm-left">
                        ...
                        <li class="list-group-item d-block">
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-2"><img src="//placehold.it/80" alt="Rosemary Porter"
                                                                           class="img-fluid rounded-circle mx-auto d-block">
                                </div>
                                <div class="col-12 col-sm-6 col-md-10 text-center text-sm-left"><span
                                            title="left you a message"
                                            class="fa fa-envelope fa-lg text-danger float-right"></span>
                                    ...
                                    <br> <a href="" class="link small text-truncate">rosemary.porter@example.com</a>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item d-block">
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-2"><img src="//placehold.it/80" alt="Debbie Schmidt"
                                                                           class="img-fluid rounded-circle mx-auto d-block">
                                </div>
                                <div class="col-12 col-sm-6 col-md-10 text-center text-sm-left">
                                    ...
                                    <br> <a href="" class="link small text-truncate">debbie.schmidt@example.com</a>
                                </div>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="row my-3">
                ...
                <div class="col-sm-6">
                    <div id="accordion" class="accordion">
                        <div class="card card-default panel"><a href="" data-toggle="collapse"
                                                                data-target="#collapseOne"
                                                                class="card-header text-white bg-dark"><span
                                        class="card-title">
                                        Accordion Item 1
                                    </span></a>
                            <div id="collapseOne" class="card-body collapse show" data-parent="#accordion">
                                <p>Food truck quinoa nesciunt laborum for labo lucn. Nihil anim keffiyeh helvetica,
                                    craft beer labore wes anderson cred nesciunt sapiente ea proident. Leggings occaecat
                                    craft beer farm-to-table, raw denim aesthetic synth
                                    nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                </p>
                            </div>
                            <a href="" data-toggle="collapse" data-target="#collapseTwo"
                               class="card-header text-white bg-dark collapsed"><span class="card-title">
                                        Accordion Item 2
                                    </span></a>
                            <div id="collapseTwo" class="card-body collapse" data-parent="#accordion">
                                <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson
                                    ad squid. Officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
                                    nesciunt laborum eiusmod. Brunch 3 wolf moon tempor,
                                    sunt cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo.
            ...
            <div class="row py-3">
                <div class="col-lg-4 col-sm-6 py-3">
                    <div class="card card-default h-100">
                        <div class="card-img-top"><img src="//placehold.it/600x300" alt="card image 1"
                                                       class="grayscale img-fluid mx-auto d-block"></div>
                        <div class="card-body d-flex flex-column">
                            <p class="text-justify">Ovi lipsim diro? Wi, wi, garius azdipiscing elit. Duis pha
                                codeply.</p> <a href="" data-target="#profileModal" data-toggle="modal"
                                                data-caption="Tammy" data-image="//placehold.it/600x300"
                                                class="btn btn-secondary btn-lg btn-block text-truncate mt-auto">View
                                Profile</a></div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 py-3">
                    <div class="card card-default h-100">
                        <div class="card-img-top"><img src="//placehold.it/600x300" alt="card image 3"
                                                       class="grayscale img-fluid mx-auto d-block"></div>
                        <div class="card-body d-flex flex-column">
                            <p class="text-justify">Shiny, shiny, shiny.</p> <a href="" data-target="#profileModal"
                                                                                data-toggle="modal"
                                                                                data-caption="Marcus"
                ...
                <div class="col-lg-4 col-sm-6 mx-auto py-3">
                    <div class="card card-default h-100">
                        <div class="card-img-top"><img src="//placehold.it/600x300" alt="card image 3"
                                                       class="grayscale img-fluid mx-auto d-block"></div>
                        <div class="card-body d-flex flex-column">
                            <p class="text-justify">Varius azdipiscing elit. Duis pharetra, ovi lipsim diro?</p> <a
                                    href="" data-target="#profileModal" data-toggle="modal" data-caption="Carry"
                                    data-image="//placehold.it/600x300"
                                    class="btn btn-secondary btn-lg btn-block text-truncate mt-auto">View Profile</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div role="alert" class="alert alert-success">
                        <h4 class="alert-heading">Yes!</h4> Aww yeah, you successfully read this important alert
                        message. This example text is going to run a bit longer so that you can see how spacing within
                        an alert works with this kind of content. Imagine the content here.
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div role="alert" class="mt-1 alert alert-info alert-dismissible fade show">
                        ...
                        <span class="font-weight-bold">Heads up!</span> Vestibulum tincidunt ullamcorper eros eget
                        luctus. Nulla <a href="#" class="alert-link">info</a> porttitor libero.
                    </div>
                    <div role="alert" class="mt-1 alert alert-danger alert-dismissible fade show">
                        <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span
                                    aria-hidden="true">�</span></button>
                        <span class="font-weight-bold">Yo there!</span> You should check <a href="#" class="alert-link">danger</a>
                        in on some of those fields below.
                    </div>
                    <div role="alert" class="mt-1 alert alert-warning alert-dismissible fade show">
                        <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span
                                    aria-hidden="true">�</span></button>
                        Food truck fixie locavore Exercitation, blog <a href="#" class="alert-link">warning</a>
                        sartorial PBR leggings.
                    </div>
                </div>
                <div class="col-sm-6">
                    <div role="alert"
                         class="mt-1 alert alert-primary bg-primary text-white alert-dismissible fade show">
                        <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span
                                    aria-hidden="true">�</span></button>
                        <span class="font-weight-bold">Womp!</span> Vestibulum tincidunt ullamcorper eros eget luctus.
                        Nulla porttitor libero.
                    </div>
                    <div role="alert" class="mt-1 alert alert-danger bg-danger text-white alert-dismissible fade show">
                        <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span
                                    aria-hidden="true">�</span></button>
                        <span class="font-weight-bold">Danger!</span> Vestibulum tincidunt ullamcorper eros eget luctus.
                        Nulla porttitor libero.
                    </div>
                    <div role="alert" class="mt-1 alert alert-success bg-success alert-dismissible fade show">
                        <button type="button" data-dismiss="alert" aria-label="Close" class="close"><span
                                    aria-hidden="true">�</span></button>
                        <span class="font-weight-bold">Success!</span> Vestibulum tincidunt ullamcorper eros eget
                        luctus. Nulla porttitor libero.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="list-inline text-center">
                <li class="list-inline-item py-1"><a href="" data-target="#myModal" data-toggle="modal"
                                                     class="btn btn-outline-secondary btn-sm">Standard</a></li>
                <li class="list-inline-item py-1"><a href="" data-target="#smallModal" data-toggle="modal"
                                                     class="btn btn-outline-secondary btn-sm">Small</a></li>
                <li class="list-inline-item py-1"><a href="" data-target="#largeModal" data-toggle="modal"
                                                     class="btn btn-outline-secondary btn-sm">Large</a></li>
            </ul>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content text-center">
                        <div class="modal-body text-center">
                            <div role="alert" class="alert text-white bg-primary fade show"><span
                                        class="font-weight-bold">Womp!</span> There it is.
                            </div>
                            <a data-dismiss="modal"><span aria-hidden="true" class="display-2">�</span></a></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-content text-center p-3">
                        <div class="modal-body text-center">
                            ...
                            <p class="lead">
                                ...
                                squid. Officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt
                                laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid
                                single-origin coffee nulla assumenda shoreditch et. Ad vegan excepteur butcher vice
                                lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you
                                probably haven't heard of them accusamus labore
                                sustainable VHS.
                            </p>
                            <button type="button" data-dismiss="modal"
                                    class="btn btn-lg btn-primary mt-2 text-uppercase"><span
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item"><a href="" aria-label="Previous" class="page-link"><i
                                                        class="fa fa-chevron-left ion-ios-arrow-left"></i> <span
                                        ...
                                        <li class="page-item"><a href="" aria-label="Next" class="page-link"><i
                                                        class="fa fa-chevron-right ion-ios-arrow-right"></i> <span
            ...
            <div class="row mt-2">
                <div class="col-lg-6">
                    <div class="card card-default">
                        <h4 class="card-header"><a href="#" data-target="#collapseMe" data-toggle="collapse"
                                                   class="float-right"><i class="align-middle fa fa-ellipsis-v"></i></a>
                            Heading
                        </h4>
                        <div id="collapseMe" class="collapse show card-body">
                            <p>Shiny, shiny. Varius azdipiscing elit. Duis pharetra codeply varius quam sit amet
                                vulputate. Ovi lipsim diro? Then puska craft beer labore wes anderson cred nesciunt
                ...
                <div class="col-lg-6">
                    <div id="accordion2" class="accordion">
                        <div class="card">
                            ...
                            <a data-toggle="collapse" href="#" data-target="#collapseTwo2"
                            ...
                            <a data-toggle="collapse" href="#" data-target="#collapseThree2"
                               class="card-header collapsed">
                                    <span class="card-title">
                                        Panel 3
                                    </span>
    ...
    <div class="row h-100 align-items-center">
        <div class="col-12">
            ...
            <div class="row mt-2">
                ...
                <div class="col-lg col-4">
                    <button class="btn btn-danger mr-1">Danger <span class="badge badge-light badge-pill">!</span>
                    </button>
                </div>
                <div class="col-lg col-4">
                ...
                <div class="col-lg col-3">
                    <div class="dropdown">
                        ...
                        <div aria-labelledby="dropdownMenuButton" class="dropdown-menu"><a href="#"
                            ...
                            <a href="#" class="dropdown-item">Another action</a> <a href="#" class="dropdown-item">Something
                                else here</a></div>
                    </div>
                </div>
                <div class="col-lg col-3">
                    <div class="btn-group">
                        ...
                        <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                class="btn btn-secondary dropdown-toggle dropdown-toggle-split"><span class="sr-only">Toggle Dropdown</span>
                        </button>
                        <div class="dropdown-menu"><a href="#" class="dropdown-item">Action</a> <a href="#"
                            ...
                            <a href="#" class="dropdown-item">Separated link</a></div>
                    </div>
                </div>
                <div class="col-lg col-3">
        ...
        <div class="col-md-12">
            ...
            <div class="row mt-2">
                <div class="col-lg-3 pb-2">
                    <h6>Normal</h6> <a href=""><span class="badge badge-dark">badge</span></a> <a href=""><span
                                class="badge badge-success">success</span></a> <a href=""><span
                                class="badge badge-danger">danger</span></a>
                    <div class="w-100 my-3"></div>
                    <a href=""><span class="badge badge-warning">warning</span></a> <a href=""><span
                                class="badge badge-info">info</span></a> <a href=""><span class="badge badge-primary">primary</span></a>
                    <div class="w-100 my-3"></div>
                    <a href=""><span class="badge badge-pill badge-dark">pill</span></a> <a href=""><span
                                class="badge badge-pill badge-success">100k</span></a> <a href=""><span
                                class="badge badge-pill badge-info">2</span></a>
                    <a href=""><span class="badge badge-pill badge-danger">378</span></a> <a href=""><span
                                class="badge badge-pill badge-warning">tag</span></a> <a href=""><span
                                class="badge badge-pill badge-primary">1123</span></a></div>
                <div class="col-lg-4 pb-2">
                    <h5>Heading 5</h5>
                    <h5 class="mt-2"><a href=""><span class="badge badge-dark">badge</span></a> <a href=""><span
                                    class="badge badge-success">success</span></a> <a href=""><span
                                    class="badge badge-danger">danger</span></a>
                        <div class="w-100 my-3"></div>
                        <a href=""><span class="badge badge-warning">warning</span></a> <a href=""><span
                                    class="badge badge-info">info</span></a> <a href=""><span
                                    class="badge badge-primary">primary</span></a>
                        <div class="w-100 my-3"></div>
                        <a href=""><span class="badge badge-pill badge-dark">pill</span></a> <a href=""><span
                                    class="badge badge-pill badge-success">100k</span></a> <a href=""><span
                                    class="badge badge-pill badge-info">2</span></a> <a href=""><span
                                    class="badge badge-pill badge-danger">378</span></a> <a href=""><span
                                    class="badge badge-pill badge-warning">tag</span></a> <a href=""><span
                                    class="badge badge-pill badge-primary">1123</span></a></h5>
                </div>
