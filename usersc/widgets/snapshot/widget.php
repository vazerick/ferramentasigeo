        ...
        <aside class="profile-nav alt">
            <section class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <a href="https://userspice.com/kb/" target="_blank"> <i class="fa fa-book"></i> Documentation
                        </a>
                    </li>

                    <li class="list-group-item">
                        <a href="https://discord.gg/PMNquvh" target="_blank"> <i class="fa fa-comments"></i> Live
                            Discord Chat </a>
                    </li>

                    <li class="list-group-item">
                        <a href="https://www.youtube.com/playlist?list=PLixQt02ELp8onA67F4yrVbLnTOYsSBhxZ"
                           target="_blank"> <i class="fa fa-quote-left"></i> UserSpice Videos</a>
                    </li>

                    <li class="list-group-item">
                        <a href="https://www.patreon.com/userspice" target="_blank"> <i class="fa fa-heart"></i> Support
                            UserSpice </a>
                    </li>
                </ul>
            </section>
        ...
        <aside class="profile-nav alt">
            <section class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    foreach ($top as $t) { ?>
                        <li class="list-group-item">
                            <a href="admin.php?view=users&id=<?= $t->id ?>"> #<?= $count ?> <?php echoUser($t->id); ?>
                                <span class="badge badge-primary pull-right"><?= $t->logins ?> logins</span></a>
                        </li>
                        <?php
                        $count++;
                    } ?>
